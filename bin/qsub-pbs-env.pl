...
while(<IN>){
	...
	if ($line_mark % $Lines == 0) {
		open OUT,">$Work_dir/$Job_prefix\_$Job_mark.sh" || die "failed creat $Job_prefix\_$Job_mark.sh";
                ...
                print OUT "PYTHONPATH=/rhome/cjinfeng/BigData/00.RD/Assembly/Pacbio/install/pythonlib/:/rhome/cjinfeng/BigData/00.RD/Assembly/Pacbio/install/pythonlib/lib64/python2.7/site-packages/:/rhome/cjinfeng/BigData/00.RD/Assembly/Pacbio/install/pythonlib/lib/python2.7/site-packages/\n\n";
